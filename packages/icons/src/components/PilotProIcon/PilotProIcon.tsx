...
const ModPilotProIcon = styled.svg`
  fill: ${props => props.fill ? props.fill : ({theme}) => theme.color.primary};
  height: 4em;
  width: 14em;
`;

const PilotProIcon = ({ fill, height, width, ...props  }: IconProps) => {
  return (
    <ModPilotProIcon
      {...props}
      version='1.0'
    ...
    >
      ...
      <metadata>Created by Prashan Pudasaini on Thursday, April 13th, 2024 @ fullstackpro.io</metadata>
      <g transform="translate(0.000000,417.000000) scale(0.100000,-0.100000)"
        fill={fill} stroke="none">
        <path d="M2385 3098 c-77 -182 -88 -227 -88 -363 0 -127 10 -172 65 -274 29
        ...
        <path d="M6817 3105 c-9 -20 -17 -40 -17 -45 0 -25 -79 -139 -137 -196 -91
        ...
        <path d="M4034 2371 c-187 -60 -318 -195 -360 -371 -60 -249 97 -474 581 -836
