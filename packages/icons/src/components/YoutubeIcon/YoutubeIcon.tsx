...
const ModYoutubeIcon = styled.svg`
...
const YoutubeIcon = ({ fill, height, width, ...props  }: IconProps) => {
  return (
    <ModYoutubeIcon
      {...props}
      version='1.0'
    ...
    >
      ...
      <g transform='translate(0.000000,876.000000) scale(0.100000,-0.100000)' fill={fill} stroke='none'>
        {' '}
