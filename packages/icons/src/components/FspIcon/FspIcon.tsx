...
const FspIcon = ({ fill, height, width, ...props  }: IconProps) => {
  return (
    <ModFspIcon
      {...props}
      version='1.0'
      ...
      width = {width}
    >
      <title>Full Stack Coder Icon</title>
      <metadata>Created by Prashan Pudasaini on Thursday, January 4th, 2024 @ fullstackpro.io</metadata>
      <g transform='translate(0.000000,723.000000) scale(0.100000,-0.100000)' fill={fill} stroke='none'>
        {' '}
